...
--> statement-breakpoint
ALTER TABLE "user" RENAME COLUMN "name" TO "employee_number";--> statement-breakpoint
...
ALTER TABLE "user" ADD CONSTRAINT "user_employee_number_unique" UNIQUE("employee_number");